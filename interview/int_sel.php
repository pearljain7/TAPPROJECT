<?php  
 ...
 $output = '';  
 $sql = "SELECT * FROM form ORDER BY email DESC";  
      ...
      {  
           $output .= '  
                <tr>  
                     ...
                     <td><button type="button"  name="accept_btn" id="accept_btn" data-id5="'.$row["email"].'" class="btn btn-xs btn-danger btn_delete">Accept</button><p></p>
                     <button type="button" name="reject_btn" id="reject_btn" data-id6="'.$row["email"].'" class="btn btn-xs btn-danger btn_delete">Reject</button></td>  
                </tr>  
           ';  
      }  
     /* $output .= '  
