        ...
        <nav class="navbar" id="insidenav">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="../index.php">TheApprenticeProject</a>
                </div>
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">Facilitator Registration</a></li>
...
<div class="container">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1>Register</h1>
            <p>
                If you believe that poverty shouldn’t dictate a child’s destiny and if you believe in the transformational power of arts and sports.<br/>
                Apply as facilitator for TAP and help students learn better.
            </p>
        </div>
...
<div class="form-group"> 
    <label class="control-label col-sm-4" for="skills"> What are your Key Skills:</label>
         <div class="col-sm-4">
            <select name="clubs" class="form-control" id="clubs" required>
                <option value="">SELECT </option>
                ...
                <option value="Electronics and Coding">Electronics and Coding </option>
